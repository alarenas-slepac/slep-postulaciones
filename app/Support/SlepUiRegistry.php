    ...
    public static function menuGroups($user, ?string $activeRole): array
    {
        $entries = [
            ...
            'Trámites y operación' => [
                ...
                self::entry('Idoneidad psicológica AAEE', 'tramites.idoneidad-psicologica.index', 'bi-shield-check', ['admin', 'coordinador_gdp', 'funcionario_slep']),
            ...
            'Administración' => [
                ...
                self::entry('Dotación funciones y planes', 'admin.dotacion-funciones.index', 'bi-diagram-3-fill', ['admin', 'funcionario_directivo_estab', 'coordinador_uatp', 'coordinador_gdp', 'supervisor_plani'], 'admin.dotacion-funciones'),
