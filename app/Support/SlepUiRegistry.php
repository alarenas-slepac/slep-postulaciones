    ...
    public static function menuGroups($user, ?string $activeRole): array
    {
        $entries = [
            ...
            'Centro de Operaciones' => [
                ...
                self::entry('Mantenedor de riesgo IRTE', 'centro-operaciones.riesgos.configuracion', 'bi-ui-checks-grid', ['admin']),
            ],
            ...
            'Administración' => [
                ...
                self::entry('Cursos', 'admin.cursos.index', 'bi-layers', ['admin'], 'admin.cursos'),
                self::entry('Planes de estudio', 'admin.planes-estudio.index', 'bi-journal-bookmark', ['admin'], 'admin.planes-estudio'),
                self::entry('Cursos por establecimiento', 'admin.establecimiento-cursos.index', 'bi-mortarboard', ['admin'], 'admin.establecimiento-cursos'),
                ...
                self::entry('Dotación establecimiento', 'admin.dotacion-establecimiento.index', 'bi-building-check', ['admin', 'funcionario_directivo_estab', 'coordinador_uatp', 'coordinador_gdp'], 'admin.dotacion-establecimiento'),
                self::entry('Configurar planes EE', 'admin.establecimiento-planes.index', 'bi-ui-checks-grid', ['admin', 'funcionario_directivo_estab'], 'admin.establecimiento-planes'),
                self::entry('Asignaturas', 'admin.asignaturas.index', 'bi-book', ['admin'], 'admin.asignaturas'),
