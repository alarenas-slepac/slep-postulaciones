...
{
    public static function build(array $base, int $anio, array $continuidadPorRut): array
    {
        ...
        return [
            ...
            'brechas' => [
                'aula' => round($necesarias['plan_general'] + $necesarias['funciones_normativas'] - $contratos['aula'], 2),
                'parvularia' => round($necesarias['parvularia'] - $contratos['parvularia'], 2),
                'pie' => round($necesarias['pie'] - $contratos['pie'], 2),
            ],
