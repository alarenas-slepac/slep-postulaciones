...
class SolicitudReemplazoRechazadaPlani extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject("Solicitud de reemplazo {$s->numero_solicitud} (Rechazada por Planificación)")
            ->view('emails.solicitud-reemplazo-rechazada-plani', ['s' => $s])
