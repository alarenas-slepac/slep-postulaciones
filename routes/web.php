...
Route::middleware(['auth', 'verified', 'ensure.module'])->group(function () {
    ...
    Route::prefix('tramites/licencias-medicas')
        ...
        ->group(function () {
            ...
            Route::get('/errores-importacion', [LicenciaMedicaImportacionErrorController::class, 'index'])->middleware($importacion)->name('errores.index');
            Route::post('/errores-importacion/cargas/{importacion}/indexar', [LicenciaMedicaImportacionErrorController::class, 'indexar'])->middleware($importacion)->name('errores.indexar');
            Route::get('/errores-importacion/{errorImportacion}', [LicenciaMedicaImportacionErrorController::class, 'show'])->middleware($importacion)->name('errores.show');
            Route::patch('/errores-importacion/{errorImportacion}', [LicenciaMedicaImportacionErrorController::class, 'update'])->middleware($importacion)->name('errores.update');
            Route::post('/errores-importacion/{errorImportacion}/reprocesar', [LicenciaMedicaImportacionErrorController::class, 'reprocesar'])->middleware($importacion)->name('errores.reprocesar');
