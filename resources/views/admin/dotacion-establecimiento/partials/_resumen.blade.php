...
<div class="card dotacion-section mb-4">
    ...
    <div class="card-body">
        ...
        <div class="alert alert-info border-0 rounded-4 small">
            ...
            Para cubrir el plan completo de NT1/NT2 con JEC se consideran 55 h de contrato por curso o grupo combinado. Sin JEC: NT1 requiere 35 h, NT2 requiere 31 h y el grupo NT1 + NT2 requiere 35 h, exclusivamente por Educadoras de Párvulos, sin libre disposición. Se agregan 3 h de contrato PIE cuando corresponda, una sola vez por curso o grupo. Con JEC, la libre disposición de otro docente se contabiliza aparte en Contrato Plan General + PIE: máximo 6 h de plan por curso independiente o grupo combinado; su contrato equivalente se calcula mediante 65/35. En combinados se conserva el mayor refuerzo de los integrantes, no su suma. El resto de cursos mantiene 65/35 o 60/40 según corresponda.
