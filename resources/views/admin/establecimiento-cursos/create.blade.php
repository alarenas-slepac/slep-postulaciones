...
@section('content')
    <div class="d-flex align-items-center justify-content-between gap-3 mb-3">
        <div>
            <h1 class="h4 mb-1">Nuevo curso por establecimiento</h1>
            <div class="text-muted small">Registra una sección, matrícula y plan asociado.</div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.establecimiento-cursos.store') }}" class="card card-body shadow-sm">
        @csrf
