...
@section('content')
<div id="votaciones-publicas" data-state-url="{{ route('public.votaciones.estado',$jornada) }}" data-polling-ms="{{ config('votaciones.polling_ms',10000) }}">
