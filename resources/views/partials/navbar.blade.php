        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto">
                @auth
                    ...
                    @if ($canAccessBulkRoleMail || ($isAdmin && ($u->canAnyModule(['admin.users', 'admin.roles', 'admin.restricted-ruts', 'admin.notification-logs'], $activeRole) || Route::has('admin.postulaciones.index'))))
                        <li class="nav-item dropdown">
