...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5">
                <div class="dpa-panel"><div class="dpa-panel__header"><div class="dpa-panel__title">Cargar resolución o dictamen</div><p class="dpa-panel__subtitle">Al reemplazar el documento, SLEP verá inmediatamente la nueva versión y su fecha de carga.</p></div><div class="dpa-panel__body">
                    <form method="POST" action="{{ route('postulant.deudas-pension-alimentos.resolucion.store', $deuda) }}" enctype="multipart/form-data">@csrf
                        <div class="mb-3"><label for="valor_cuota_alimentaria" class="form-label fw-semibold">Valor mensual de la cuota alimentaria <span class="text-danger">*</span></label><div class="input-group"><span class="input-group-text">$</span><input id="valor_cuota_alimentaria" name="valor_cuota_alimentaria" type="number" min="1" step="1" class="form-control" value="{{ old('valor_cuota_alimentaria', $deuda->valor_cuota_alimentaria) }}" required></div></div>
                        ...
                        <div class="mb-3"><label for="observacion_postulante" class="form-label fw-semibold">Observación</label><textarea id="observacion_postulante" name="observacion_postulante" rows="3" class="form-control" maxlength="2000">{{ old('observacion_postulante', $deuda->observacion_postulante) }}</textarea></div>
